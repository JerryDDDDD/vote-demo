...
import com.layman.handler.VoteHandler;
 ...
 **/
@Component
public class VoteChannelInit extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        //自定义handler()
        pipeline.addLast(new VoteHandler());
    }
}
